...
var author$project$Telegram$decodeChat = A3(
...
var author$project$Telegram$decodeMessage = A5(
...
var author$project$Telegram$decodeUpdate = A3(
	elm$json$Json$Decode$map2,
	...
	function (model, newUpdate) {
		...
		return _Utils_Tuple2(
			...
			author$project$Main$sendMessage(
				author$project$Elmergram$encodeSendMessage(answer)));
	});
